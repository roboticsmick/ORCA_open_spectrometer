...
class SpectrometerController:
    ...
    def _initialize_spectrometer(self) -> bool:
        ...
        if sb is None or Spectrometer is None:
            print("ERROR: Seabreeze libraries not loaded. Cannot initialize spectrometer.")
            return False
        ...
        try:
            ...
            try:
                ...
                print(f"  Integration time limits: {self._hw_min_integration_us} - {self._hw_max_integration_us} µs")
            except (AttributeError, TypeError, ValueError) as e:
                print(f"  WARNING: Could not query integration limits ({e}). Using defaults.")
    ...
    def _update_settings(self, cmd: SpectrometerCommand):
        ...
        if cmd.integration_time_ms is not None:
            if cmd.integration_time_ms != self._integration_time_ms:
                ...
                print(f"SpectrometerController: Integration time updated to {self._integration_time_ms} ms")
        ...
        if cmd.scans_to_average is not None:
            if cmd.scans_to_average != self._scans_to_average:
                ...
                settings_changed = True
                print(f"SpectrometerController: Scans to average updated to {self._scans_to_average}")
    ...
    def _capture_dark_reference(self):
        ...
        if raw_intensities is not None:
            ...
            print("SpectrometerController: Dark reference captured successfully")
        else:
    ...
    def _capture_white_reference(self):
        ...
        if raw_intensities is not None:
            ...
            print("SpectrometerController: White reference captured successfully")
        else:
    ...
    def _calculate_reflectance(self, raw_intensities: np.ndarray) -> np.ndarray:
        ...
        Returns:
            Reflectance array (clipped to 0.0 - 1.0)
        """
